...
class MaterialImageOpacityBuilder extends StatefulWidget {
  const MaterialImageOpacityBuilder({
    Key? key,
  ...
  @override
  _MaterialImageOpacityBuilderState createState() => _MaterialImageOpacityBuilderState();
}

class _MaterialImageOpacityBuilderState extends State<MaterialImageOpacityBuilder> with InheritedAnimationMixin {
  ...
  @override
  void didUpdateWidget(covariant MaterialImageOpacityBuilder oldWidget) {
...
/// A single animation for [MaterialImageOpacityBuilder] to pass down
/// to [RawImage].
///
