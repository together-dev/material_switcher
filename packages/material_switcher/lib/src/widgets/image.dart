...
class _ImageState extends State<Image> with WidgetsBindingObserver {
  ...
  void _replaceImage({required ImageInfo? info}) {
    ...
    //
    // Dispose the image in a postframe, so animation widgets can clone this in time.
  ...
  Widget build(BuildContext context) {
    ...
    // HACK: Differs from Flutter's Image.
    // TODO(volskaya): Find a better way to identify [RawImages] or push a patch to Flutter.
    final fakeKey =
        _imageInfo?.image != null ? ValueKey(hashValues(_imageInfo!.image.width, _imageInfo!.image.height)) : null;
